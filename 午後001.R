...
esheet = excel_sheets(filename) # xlsx ファイルのシート名

d1 = read_xlsx(filename, sheet = esheet[1],　col_types = "text")
d2 = read_xlsx(filename, sheet = esheet[2],　col_types = "text")
